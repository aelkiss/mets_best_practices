...
require "shared_examples/idref_examples"
require "shared_examples/validation_examples"
...
# join strings with 'or' (including an oxford comma)
def or_join(strings)
  case strings.length
  when 1
    strings[0]
